...
contract StakedToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked ORION", "sORION", 9) ERC20Permit() {
    ...
    /**
        @notice increases sORION supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sORION
